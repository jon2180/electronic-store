...
public class ProductDAOImpl implements ProductDAO {
    ...
    @Override
    public boolean save(Product product) throws RuntimeException {
    ...
    @Override
    public List<Product> findByIDs(Integer... ids) throws RuntimeException {
    ...
    @Override
    public Page<Product> findByPaging(int number, int size) throws RuntimeException {
