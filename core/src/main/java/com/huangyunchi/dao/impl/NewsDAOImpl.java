...
public class NewsDAOImpl implements NewsDAO {
    ...
    @Override
    public boolean save(News news) throws RuntimeException {
    ...
    public boolean update(News news) throws RuntimeException {
    ...
    @Override
    public News findByID(Integer id) throws RuntimeException {
        News news = null;
    ...
    @Override
    public Page<News> findByPaging(int number, int size) throws RuntimeException {
